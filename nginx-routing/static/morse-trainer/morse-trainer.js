...
const DIT_DURATION = 0.100; // seconds
const DAH_DURATION = 3 * DIT_DURATION;
const SYMBOL_SEP = DIT_DURATION;
const LETTER_SEP = 3 * DIT_DURATION;
const WORD_SEP = 7 * DIT_DURATION;
